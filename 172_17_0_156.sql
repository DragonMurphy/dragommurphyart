...
--
-- Host: 172.17.0.156
-- Generation Time: Dec 14, 2016 at 03:56 AM
...
CREATE TABLE IF NOT EXISTS `bigtree_404s` (
...
CREATE TABLE IF NOT EXISTS `bigtree_audit_trail` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 1, 'bigtree_pages', '2', 'updated', '2016-12-13 15:41:25'),
(2, 1, 'bigtree_pages', '2', 'saved-draft', '2016-12-13 15:42:55'),
(3, 1, 'bigtree_pages', '2', 'updated', '2016-12-13 15:43:11'),
(4, 1, 'bigtree_pages', '2', 'saved-draft', '2016-12-13 15:43:46'),
(5, 1, 'bigtree_pages', 'p3', 'created-pending', '2016-12-13 15:44:31'),
(6, 1, 'bigtree_pages', '0', 'saved-draft', '2016-12-13 15:46:56'),
(7, 1, 'bigtree_pages', '3', 'saved-draft', '2016-12-13 15:48:28'),
(8, 1, 'bigtree_pages', '3', 'updated', '2016-12-13 15:48:38'),
(9, 1, 'bigtree_pages', '0', 'updated-draft', '2016-12-13 15:48:53'),
(10, 1, 'bigtree_pages', '2', 'updated', '2016-12-13 15:49:11'),
(11, 1, 'demo_trees', '1', 'updated', '2016-12-13 15:53:07');
...
CREATE TABLE IF NOT EXISTS `bigtree_caches` (
...
CREATE TABLE IF NOT EXISTS `bigtree_callout_groups` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_callouts` (
...
CREATE TABLE IF NOT EXISTS `bigtree_extensions` (
...
CREATE TABLE IF NOT EXISTS `bigtree_feeds` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_field_types` (
  `id` varchar(255) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_locks` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user` int(11) unsigned NOT NULL,
  `table` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_login_attempts` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 635764100, 1, '2016-12-13 15:40:37');
...
CREATE TABLE IF NOT EXISTS `bigtree_login_bans` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ip` int(11) DEFAULT NULL,
  `user` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_messages` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_module_actions` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 1, 'View Trees', '', 'on', NULL, 1, NULL, 'list', 0, 0),
(2, 1, 'Add Tree', 'add', 'on', 1, NULL, NULL, 'add', 0, 0),
(3, 1, 'Edit Tree', 'edit', '', 1, NULL, NULL, 'edit', 0, 0),
(4, 2, 'View Quotes', '', 'on', NULL, 2, NULL, 'list', 0, 0),
(5, 2, 'Add Quote', 'add', 'on', 2, NULL, NULL, 'add', 0, 0),
(6, 2, 'Edit Quote', 'edit', '', 2, NULL, NULL, 'edit', 0, 0);
...
CREATE TABLE IF NOT EXISTS `bigtree_module_embeds` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_module_forms` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 1, 'Tree', 'demo_trees', '[{"title":"Title","subtitle":"","type":"text","options":[],"column":"title"},{"title":"Subtitle","subtitle":"","type":"text","options":[],"column":"subtitle"},{"title":"Route","subtitle":"","type":"route","options":{"source":"title"},"column":"route"},{"title":"Content","subtitle":"","type":"html","options":[],"column":"content"},{"title":"Cover","subtitle":"(1200x600 minimum size)","type":"upload","options":{"directory":"files\\/trees\\/","image":"on","min_width":"1200","min_height":"600","preview_prefix":"thumb_","crops":[{"prefix":"","width":"1200","height":"600","grayscale":"","thumbs":[null,{"prefix":"thumb_","width":"200","height":"","grayscale":""},{"prefix":"large_","width":"775","height":"","grayscale":""}]}]},"column":"cover"},{"title":"Cover Attribution","subtitle":"","type":"text","options":[],"column":"cover_attribution"},{"title":"Cover Link","subtitle":"(include http:\\/\\/)","type":"text","options":[],"column":"cover_link"},{"title":"Gallery","subtitle":"(275x275 mimimum size)","type":"photo-gallery","options":{"directory":"files\\/trees\\/","min_width":"275","min_height":"275","preview_prefix":"thumb_","crops":[{"prefix":"thumb_","width":"275","height":"275","grayscale":""}],"thumbs":[{"prefix":"","width":"1200","height":"1200","grayscale":""}]},"column":"gallery"},{"title":"External Link","subtitle":"(optional, include http:\\/\\/)","type":"text","options":[],"column":"link"}]', 'Bottom', NULL, '', '', '[]'),
(2, 2, 'Quote', 'demo_quotes', '[{"title":"Quote","subtitle":"","type":"textarea","options":null,"column":"quote"},{"title":"Author","subtitle":"","type":"text","options":null,"column":"author"},{"title":"Source","subtitle":"","type":"text","options":null,"column":"source"}]', 'Bottom', NULL, '', '', '[]');
...
CREATE TABLE IF NOT EXISTS `bigtree_module_groups` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_module_reports` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `module` int(11) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_module_view_cache` (
...
INSERT INTO `bigtree_module_view_cache` (`view`, `id`, `gbp_field`, `published_gbp_field`, `group_field`, `sort_field`, `group_sort_field`, `position`, `approved`, `archived`, `featured`, `status`, `pending_owner`, `column1`, `column2`, `column3`, `column4`, `column5`, `column6`) VALUES
('1', '2', '', '', '', '', '', 0, '', '', '', 'l', 0, 'The Sequoia', '', '', '', '', ''),
('1', '3', '', '', '', '', '', 0, '', '', '', 'l', 0, 'The Pine', '', '', '', '', ''),
('1', '1', '', '', '', '', '', 0, '', '', '', 'l', 0, 'Animation', '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `bigtree_module_views` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `module` int(11) unsigned DEFAULT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
  `description` text NOT NULL,
...
(1, 1, 'Trees', '', 'draggable', 'demo_trees', '{"title":{"title":"Title","parser":"","width":788,"numeric":false}}', '{"sort":"`date` DESC","per_page":"15","filter":""}', '{"edit":"on","delete":"on"}', '', NULL),
(2, 2, 'Quotes', '', 'draggable', 'demo_quotes', '{"quote":{"title":"Quote","parser":"","width":364,"numeric":false},"author":{"title":"Author","parser":"","width":364,"numeric":false}}', 'null', '{"approve":"on","edit":"on","delete":"on"}', '', NULL);
...
CREATE TABLE IF NOT EXISTS `bigtree_modules` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, NULL, 'Trees', 'trees', 'DemoTrees', 'world', '{"name":"","table":"","other_table":""}', 0, NULL),
(2, NULL, 'Quotes', 'quotes', 'DemoQuotes', 'comments', '{"name":"","table":"","other_table":""}', 0, NULL);
...
CREATE TABLE IF NOT EXISTS `bigtree_page_revisions` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 2, 'The Trees', '', '', 'trees', '', '', '{"page_header":"The Trees"}', 1, '', '', '2013-12-13 10:23:59'),
(2, 2, 'The Trees', '', '', 'trees', '', '', '{\n    "page_header": "David Murphy Portfolio"\n}', 1, '', '', '2016-12-13 15:41:25'),
(3, 3, 'The Quotes', '', '', 'quotes', '', '', '{"page_header":"The Quotes"}', 1, '', '', '2013-12-13 10:24:07'),
(4, 2, 'The Trees', '', '', 'trees', '', '', '{\n    "page_header": "David Murphy Portfolio"\n}', 1, '', '', '2016-12-13 15:43:11');
...
CREATE TABLE IF NOT EXISTS `bigtree_pages` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_pending_changes` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_resource_allocation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_resource_folders` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_resources` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_route_history` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_settings` (
  `id` varchar(255) NOT NULL DEFAULT '',
...
('bigtree-internal-cron-last-run', 0x223134383136343336323722, '', '', '', '', '', 'on', '', NULL),
...
('bigtree-internal-google-analytics-api', , '', '', '', '', '', 'on', 'on', NULL),
...
('colophon', 0x223c703e4275696c74206f6e203c6120687265663d5c22687474703a5c2f5c2f7777772e62696774726565636d732e6f72675c2f5c22207461726765743d5c225f626c616e6b5c223e4269675472656520434d533c5c2f613e3c5c2f703e22, 'html', '', 'Colophon', '', '', '', '', NULL),
...
CREATE TABLE IF NOT EXISTS `bigtree_tags` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bigtree_tags_rel` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `table` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bigtree_templates` (
  `id` varchar(255) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `bigtree_user_sessions` (
  `id` varchar(255) NOT NULL DEFAULT '',
...
('session-58501684c02bf5.72918812', '', 'chain-58501684c00821.36345461');
...
CREATE TABLE IF NOT EXISTS `bigtree_users` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(1, 'dragonmurphy101@gmail.com', '$P$BONMGXLt3m7jjoJhg33s0K3.KqX56U/', 'David', '', 2, '', '', '', '');
...
(1, 'To dwellers in a wood, almost every species of tree has its voice as well as its feature.', 'Thomas Hardy', 'Under the Greenwood Tree ', 'on', 0),
(2, 'The creation of a thousand forests is in one acorn', 'Ralph Waldo Emerson', '', 'on', 0),
(3, 'The clearest way into the Universe is through a forest wilderness.', 'John Muir', '', 'on', 0),
(4, 'Love the trees until their leaves fall off, then encourage them to try again next year.', 'Chad Sugg', '', 'on', 0),
(5, 'A cold wind was blowing from the north, and it made the trees rustle like living things.', 'George R.R. Martin', 'A Game of Thrones ', 'on', 0),
(6, 'Trees''re always a relief, after people.', 'David Mitchell', 'Black Swan Green', 'on', 0),
(7, 'We need to save the forests. I have a big warehouse we can store them in.', 'Bauvard', 'Some Inspiration for the Overenthusiastic ', 'on', 0),
(8, 'There is always music amongst the trees in the Garden, but our hearts must be very quiet to hear it.', 'Minnie Aumonier', '', 'on', 0),
(9, 'Trees are poems that the earth writes upon the sky.', 'Kahlil Gibran', 'Sand and Foam', 'on', 0),
(10, 'All our wisdom is stored in the trees.', 'Santosh Kalwar', '', 'on', 0),
(11, 'There are rich counsels in the trees.', 'Herbert P. Horne', '', 'on', 0),
(12, 'Trees are as close to immortality as the rest of us ever come.', 'Karen Joy Fowler', 'Sarah Canary', 'on', 0),
(13, 'I think that I shall never see a poem lovely as a tree.', 'Joyce Kilmer', 'Trees &amp; Other Poems ', 'on', 0),
(14, 'Great songs don''t grow on trees, yet lots of songs have been written on great trees', 'Benny Bellamacina', 'Philosophical Uplifting Quotes and Poems ', 'on', 0),
(15, 'I''m planting a tree to teach me to gather strength from my deepest roots.', 'Andrea Koehle Jones', 'The Wish Trees', 'on', 0);
...
CREATE TABLE IF NOT EXISTS `demo_trees` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `f3pkm_assets`
--

CREATE TABLE IF NOT EXISTS `f3pkm_assets` (
...
--
-- Dumping data for table `f3pkm_assets`
--

INSERT INTO `f3pkm_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(16, 1, 45, 50, 1, 'com_menus', 'com_menus', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(17, 1, 51, 52, 1, 'com_messages', 'com_messages', '{"core.admin":{"7":1},"core.manage":{"7":1}}'),
(18, 1, 53, 86, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(39, 18, 54, 55, 2, 'com_modules.module.1', 'Home', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
...
(51, 18, 78, 79, 2, 'com_modules.module.17', 'film', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(55, 18, 84, 85, 2, 'com_modules.module.87', 'Animation', '{"core.delete":{"1":0},"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
(56, 27, 19, 20, 3, 'com_content.article.1', 'Animation', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(57, 8, 28, 29, 2, 'com_content.category.8', 'Animation', '{}'),
(58, 16, 48, 49, 2, 'com_menus.menu.2', 'Animation', '{}'),
(59, 27, 21, 22, 3, 'com_content.article.2', 'Photography', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(60, 27, 23, 24, 3, 'com_content.article.3', 'Re-Dub', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(61, 27, 25, 26, 3, 'com_content.article.4', 'Re-Dub', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_associations`
--

CREATE TABLE IF NOT EXISTS `f3pkm_associations` (
...
--
-- Table structure for table `f3pkm_banner_clients`
--

CREATE TABLE IF NOT EXISTS `f3pkm_banner_clients` (
...
--
-- Table structure for table `f3pkm_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `f3pkm_banner_tracks` (
...
--
-- Table structure for table `f3pkm_banners`
--

CREATE TABLE IF NOT EXISTS `f3pkm_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `f3pkm_categories`
--

CREATE TABLE IF NOT EXISTS `f3pkm_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `f3pkm_categories`
--

INSERT INTO `f3pkm_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 500, '2016-12-14 03:30:59', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 500, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 57, 1, 11, 12, 1, 'animation', 'com_content', 'Animation', 'animation', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 500, '2016-12-14 02:11:42', 500, '2016-12-14 02:13:13', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_contact_details`
--

CREATE TABLE IF NOT EXISTS `f3pkm_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `f3pkm_content`
--

CREATE TABLE IF NOT EXISTS `f3pkm_content` (
...
--
-- Dumping data for table `f3pkm_content`
--

INSERT INTO `f3pkm_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 56, 'Animation', 'animation', '<p><strong><a href="Yhttps://vimeo.com/166998767"> Your Inner Hero</a></strong></p>\r\n<p><strong><img src="images/animeposterorignal3.1.jpg" alt="" /></strong></p>\r\n<p><span style="color: #4e5a5e; font-family: ''Helvetica Neue'', Helvetica, Arial, sans-serif; font-size: 15px; background-color: #f2f4f5;">Your Inner Hero is an Anti-Bullying Motion Comic Animation. It is about two boys Billy and Jimmy who reflect their emotions through superhero personas.</span></p>\r\n<hr title="Animation" class="system-pagebreak" />\r\n<p>https://vimeo.com/166998767</p>', '', 2, 2, '2016-12-14 02:07:38', 500, '', '2016-12-14 03:35:09', 500, 0, '0000-00-00 00:00:00', '2016-12-14 02:07:38', '0000-00-00 00:00:00', '{"image_intro":"images\\/animeposterorignal3.1.jpg","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 4, 3, '', '', 1, 8, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 59, 'Photography', 'photography', '<p><img src="images/00fa3a45841999.583ef305e4c54.jpg" alt="" /><img src="images/0bf3be45841999.583ef305e32f6.jpg" alt="" /><img src="images/1be66645841999.583eea0b5de69.jpg" alt="" /><img src="images/f17b2045841999.583eea0b5d97f.jpg" alt="" /><img src="images/e438ed45841999.583eea0b5e506.jpg" alt="" /><img src="images/f90e3545841999.583ef305e52dd.jpg" alt="" /><img src="images/fb7d1c45841999.583eea0b5e9b3.jpg" alt="" /><img src="images/38f0a345841999.583ef305e3ba6.jpg" alt="" /><img src="images/6ce1b045841999.583ef305e44aa.jpg" alt="" /></p>', '', 2, 2, '2016-12-14 03:29:25', 500, '', '2016-12-14 03:29:25', 0, 0, '0000-00-00 00:00:00', '2016-12-14 03:29:25', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 60, 'Re-Dub', 're-dub', '<p>Rocky Re-Dub</p>\r\n<p><img src="images/maxresdefault.jpg" alt="" /></p>\r\n<hr title="Rocky Re-Dub" class="system-pagebreak" />\r\n<p>&lt;iframe src="https://player.vimeo.com/video/190834494" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen&gt;&lt;/iframe&gt;</p>\r\n<p>&lt;p&gt;&lt;a href="https://vimeo.com/190834494"&gt;Rocky Re-dub&lt;/a&gt; from &lt;a href="https://vimeo.com/user33363255"&gt;DragonMurphy Art (David Murphy)&lt;/a&gt; on &lt;a href="https://vimeo.com"&gt;Vimeo&lt;/a&gt;.&lt;/p&gt;</p>', '', -2, 2, '2016-12-14 03:44:14', 500, '', '2016-12-14 03:44:14', 0, 0, '0000-00-00 00:00:00', '2016-12-14 03:46:56', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 61, 'Re-Dub', 're-dub-2', '<p>Rocky Re-Dub</p>\r\n<p><img src="images/maxresdefault.jpg" alt="" /></p>\r\n<p> </p>\r\n<p>https://vimeo.com/190834494</p>\r\n<p> </p>', '', 2, 2, '2016-12-14 03:44:17', 500, '', '2016-12-14 03:46:24', 500, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 3, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `f3pkm_content_frontpage` (
...
--
-- Table structure for table `f3pkm_content_rating`
--

CREATE TABLE IF NOT EXISTS `f3pkm_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `f3pkm_content_types`
--

CREATE TABLE IF NOT EXISTS `f3pkm_content_types` (
...
--
-- Dumping data for table `f3pkm_content_types`
--

INSERT INTO `f3pkm_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `f3pkm_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `f3pkm_contentitem_tag_map` (
...
--
-- Table structure for table `f3pkm_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `f3pkm_core_log_searches` (
...
--
-- Table structure for table `f3pkm_extensions`
--

CREATE TABLE IF NOT EXISTS `f3pkm_extensions` (
...
--
-- Dumping data for table `f3pkm_extensions`
--

INSERT INTO `f3pkm_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"e84e9f12341f9d8cd739d5a5d4354714"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1481673953}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":2,"lastrun":1481682269,"unique_id":"a570c636f6115d6a9e296362d477c1a57bee6b07","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `f3pkm_finder_filters`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_filters` (
...
--
-- Table structure for table `f3pkm_finder_links`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links` (
...
--
-- Table structure for table `f3pkm_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms0` (
...
--
-- Table structure for table `f3pkm_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `f3pkm_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `f3pkm_finder_taxonomy`
--

INSERT INTO `f3pkm_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `f3pkm_finder_terms`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_terms` (
...
--
-- Table structure for table `f3pkm_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `f3pkm_finder_terms_common`
--

INSERT INTO `f3pkm_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `f3pkm_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `f3pkm_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `f3pkm_finder_types`
--

CREATE TABLE IF NOT EXISTS `f3pkm_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `f3pkm_languages`
--

CREATE TABLE IF NOT EXISTS `f3pkm_languages` (
...
--
-- Dumping data for table `f3pkm_languages`
--

INSERT INTO `f3pkm_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_menu`
--

CREATE TABLE IF NOT EXISTS `f3pkm_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `f3pkm_menu`
--

INSERT INTO `f3pkm_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Dumping data for table `f3pkm_menu_types`
--

INSERT INTO `f3pkm_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site'),
(2, 58, 'animation', 'Animation', '');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_messages`
--

CREATE TABLE IF NOT EXISTS `f3pkm_messages` (
...
--
-- Table structure for table `f3pkm_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `f3pkm_messages_cfg` (
...
--
-- Table structure for table `f3pkm_modules`
--

CREATE TABLE IF NOT EXISTS `f3pkm_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `f3pkm_modules`
--

INSERT INTO `f3pkm_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Home', '', '', 1, 'banner', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(17, 51, 'film', '', '', 1, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"showHere":"1","showHome":"1","homeText":"Animation","showLast":"1","separator":"Animation","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"0","cachemode":"itemid","module_tag":"section","bootstrap_size":"0","header_tag":"h1","header_class":"","style":"0"}', 0, '*'),
(79, 52, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 53, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 55, 'Animation', '', '', 1, '', 0, '0000-00-00 00:00:00', '2016-12-14 02:04:46', '0000-00-00 00:00:00', 1, 'mod_articles_category', 1, 1, '{"mode":"normal","show_on_article_page":"1","count":"0","show_front":"show","category_filtering_type":"1","catid":[""],"show_child_category_articles":"0","levels":"1","author_filtering_type":"1","created_by":[""],"author_alias_filtering_type":"1","created_by_alias":[""],"excluded_articles":"","date_filtering":"off","date_field":"a.created","start_date_range":"","end_date_range":"","relative_date":"30","article_ordering":"a.title","article_ordering_direction":"ASC","article_grouping":"none","article_grouping_direction":"ksort","month_year_format":"F Y","link_titles":"1","show_date":"0","show_date_field":"created","show_date_format":"Y-m-d H:i:s","show_category":"1","show_hits":"0","show_author":"1","show_introtext":"1","introtext_limit":"100","show_readmore":"1","show_readmore_title":"1","readmore_limit":"15","layout":"_:default","moduleclass_sfx":"","owncache":"1","cache_time":"900","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_modules_menu`
--

CREATE TABLE IF NOT EXISTS `f3pkm_modules_menu` (
...
--
-- Dumping data for table `f3pkm_modules_menu`
--

INSERT INTO `f3pkm_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `f3pkm_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `f3pkm_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `f3pkm_overrider`
--

CREATE TABLE IF NOT EXISTS `f3pkm_overrider` (
...
--
-- Table structure for table `f3pkm_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `f3pkm_postinstall_messages` (
...
--
-- Dumping data for table `f3pkm_postinstall_messages`
--

INSERT INTO `f3pkm_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `f3pkm_redirect_links`
--

CREATE TABLE IF NOT EXISTS `f3pkm_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `f3pkm_schemas`
--

CREATE TABLE IF NOT EXISTS `f3pkm_schemas` (
...
--
-- Dumping data for table `f3pkm_schemas`
--

INSERT INTO `f3pkm_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_session`
--

CREATE TABLE IF NOT EXISTS `f3pkm_session` (
...
--
-- Dumping data for table `f3pkm_session`
--

INSERT INTO `f3pkm_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('8dfqe6qej68ssv15m0k69be4s2', 0, 1, '1481687628', 'joomla|s:1052:"";', 0, ''),
('qlcdlpqit695mh4ssfbl1kfvu0', 1, 0, '1481687696', 'joomla|s:9232:"";', 500, 'David');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_tags`
--

CREATE TABLE IF NOT EXISTS `f3pkm_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `f3pkm_tags`
--

INSERT INTO `f3pkm_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 500, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_template_styles`
--

CREATE TABLE IF NOT EXISTS `f3pkm_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `f3pkm_template_styles`
--

INSERT INTO `f3pkm_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `f3pkm_ucm_base`
--

CREATE TABLE IF NOT EXISTS `f3pkm_ucm_base` (
...
--
-- Table structure for table `f3pkm_ucm_content`
--

CREATE TABLE IF NOT EXISTS `f3pkm_ucm_content` (
...
--
-- Table structure for table `f3pkm_ucm_history`
--

CREATE TABLE IF NOT EXISTS `f3pkm_ucm_history` (
...
--
-- Dumping data for table `f3pkm_ucm_history`
--

INSERT INTO `f3pkm_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 1, 1, '', '2016-12-14 02:07:38', 500, 1745, '3bd62c240e261686f57d0eb76f339c80693d99b5', '{"id":1,"asset_id":56,"title":"Animation","alias":"animation","introtext":"<p>\\u00a0<\\/p>\\r\\n<p>https:\\/\\/vimeo.com\\/166998767<\\/p>","fulltext":"","state":1,"catid":"2","created":"2016-12-14 02:07:38","created_by":"500","created_by_alias":"","modified":"2016-12-14 02:07:38","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-12-14 02:07:38","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(2, 1, 1, '', '2016-12-14 02:10:45', 500, 2194, '92870474c384727f39fc76fc9c4bdcd0ca4b5b62', '{"id":1,"asset_id":"56","title":"Animation","alias":"animation","introtext":"<p><a href=\\"Yhttps:\\/\\/vimeo.com\\/166998767\\">\\u00a0Your Inner Hero<\\/a><\\/p>\\r\\n<p><span style=\\"color: #4e5a5e; font-family: ''Helvetica Neue'', Helvetica, Arial, sans-serif; font-size: 15px; background-color: #f2f4f5;\\">Your Inner Hero is an Anti-Bullying Motion Comic Animation. It is about two boys Billy and Jimmy who reflect their emotions through superhero personas.<\\/span><\\/p>\\r\\n<hr title=\\"Animation\\" class=\\"system-pagebreak\\" \\/>\\r\\n<p>https:\\/\\/vimeo.com\\/166998767<\\/p>","fulltext":"","state":1,"catid":"2","created":"2016-12-14 02:07:38","created_by":"500","created_by_alias":"","modified":"2016-12-14 02:10:45","modified_by":"500","checked_out":"500","checked_out_time":"2016-12-14 02:07:38","publish_up":"2016-12-14 02:07:38","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(3, 8, 5, '', '2016-12-14 02:11:42', 500, 555, '971a15ace189894b1908a6ef23a7bf04cabdfb2c', '{"id":8,"asset_id":57,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_content","title":"Animation","alias":"animation","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"500","created_time":"2016-12-14 02:11:42","modified_user_id":null,"modified_time":"2016-12-14 02:11:42","hits":"0","language":"*","version":null}', 0),
(4, 2, 1, '', '2016-12-14 03:29:25', 500, 2295, '1ecf29b4669f36bb17e222f18ab1c638a61f7767', '{"id":2,"asset_id":59,"title":"Photography","alias":"photography","introtext":"<p><img src=\\"images\\/00fa3a45841999.583ef305e4c54.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/0bf3be45841999.583ef305e32f6.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/1be66645841999.583eea0b5de69.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/f17b2045841999.583eea0b5d97f.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/e438ed45841999.583eea0b5e506.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/f90e3545841999.583ef305e52dd.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/fb7d1c45841999.583eea0b5e9b3.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/38f0a345841999.583ef305e3ba6.jpg\\" alt=\\"\\" \\/><img src=\\"images\\/6ce1b045841999.583ef305e44aa.jpg\\" alt=\\"\\" \\/><\\/p>","fulltext":"","state":1,"catid":"2","created":"2016-12-14 03:29:25","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:29:25","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-12-14 03:29:25","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(5, 1, 1, '', '2016-12-14 03:33:54', 500, 2210, '19b92fa9442cb548162f7dd461d4a5a4a62e58a5', '{"id":1,"asset_id":"56","title":"Animation","alias":"animation","introtext":"<p><a href=\\"Yhttps:\\/\\/vimeo.com\\/166998767\\">\\u00a0Your Inner Hero<\\/a><\\/p>\\r\\n<p><span style=\\"color: #4e5a5e; font-family: ''Helvetica Neue'', Helvetica, Arial, sans-serif; font-size: 15px; background-color: #f2f4f5;\\">Your Inner Hero is an Anti-Bullying Motion Comic Animation. It is about two boys Billy and Jimmy who reflect their emotions through superhero personas.<\\/span><\\/p>\\r\\n<hr title=\\"Animation\\" class=\\"system-pagebreak\\" \\/>\\r\\n<p>https:\\/\\/vimeo.com\\/166998767<\\/p>","fulltext":"","state":2,"catid":"2","created":"2016-12-14 02:07:38","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:33:54","modified_by":"500","checked_out":"500","checked_out_time":"2016-12-14 03:31:18","publish_up":"2016-12-14 02:07:38","publish_down":"","images":"{\\"image_intro\\":\\"images\\\\\\/animeposterorignal3.1.jpg\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"3","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(6, 1, 1, '', '2016-12-14 03:35:09', 500, 2317, '058a8f4d6c5e87dabf639a7e89dfd67ac6e6f27e', '{"id":1,"asset_id":"56","title":"Animation","alias":"animation","introtext":"<p><strong><a href=\\"Yhttps:\\/\\/vimeo.com\\/166998767\\">\\u00a0Your Inner Hero<\\/a><\\/strong><\\/p>\\r\\n<p><strong><img src=\\"images\\/animeposterorignal3.1.jpg\\" alt=\\"\\" \\/><\\/strong><\\/p>\\r\\n<p><span style=\\"color: #4e5a5e; font-family: ''Helvetica Neue'', Helvetica, Arial, sans-serif; font-size: 15px; background-color: #f2f4f5;\\">Your Inner Hero is an Anti-Bullying Motion Comic Animation. It is about two boys Billy and Jimmy who reflect their emotions through superhero personas.<\\/span><\\/p>\\r\\n<hr title=\\"Animation\\" class=\\"system-pagebreak\\" \\/>\\r\\n<p>https:\\/\\/vimeo.com\\/166998767<\\/p>","fulltext":"","state":2,"catid":"2","created":"2016-12-14 02:07:38","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:35:09","modified_by":"500","checked_out":"500","checked_out_time":"2016-12-14 03:33:54","publish_up":"2016-12-14 02:07:38","publish_down":"","images":"{\\"image_intro\\":\\"images\\\\\\/animeposterorignal3.1.jpg\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"3","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(7, 3, 1, '', '2016-12-14 03:44:14', 500, 2251, 'fbd0b4829e5358506435adec6e1f88d674120b21', '{"id":3,"asset_id":60,"title":"Re-Dub","alias":"re-dub","introtext":"<p>Rocky Re-Dub<\\/p>\\r\\n<p><img src=\\"images\\/maxresdefault.jpg\\" alt=\\"\\" \\/><\\/p>\\r\\n<hr title=\\"Rocky Re-Dub\\" class=\\"system-pagebreak\\" \\/>\\r\\n<p>&lt;iframe src=\\"https:\\/\\/player.vimeo.com\\/video\\/190834494\\" width=\\"640\\" height=\\"360\\" frameborder=\\"0\\" webkitallowfullscreen mozallowfullscreen allowfullscreen&gt;&lt;\\/iframe&gt;<\\/p>\\r\\n<p>&lt;p&gt;&lt;a href=\\"https:\\/\\/vimeo.com\\/190834494\\"&gt;Rocky Re-dub&lt;\\/a&gt; from &lt;a href=\\"https:\\/\\/vimeo.com\\/user33363255\\"&gt;DragonMurphy Art (David Murphy)&lt;\\/a&gt; on &lt;a href=\\"https:\\/\\/vimeo.com\\"&gt;Vimeo&lt;\\/a&gt;.&lt;\\/p&gt;<\\/p>","fulltext":"","state":2,"catid":"2","created":"2016-12-14 03:44:14","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:44:14","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(8, 4, 1, '', '2016-12-14 03:44:17', 500, 2253, 'f2ec5120473fbc3fe34ce7436bacacfb8a0de308', '{"id":4,"asset_id":61,"title":"Re-Dub","alias":"re-dub-2","introtext":"<p>Rocky Re-Dub<\\/p>\\r\\n<p><img src=\\"images\\/maxresdefault.jpg\\" alt=\\"\\" \\/><\\/p>\\r\\n<hr title=\\"Rocky Re-Dub\\" class=\\"system-pagebreak\\" \\/>\\r\\n<p>&lt;iframe src=\\"https:\\/\\/player.vimeo.com\\/video\\/190834494\\" width=\\"640\\" height=\\"360\\" frameborder=\\"0\\" webkitallowfullscreen mozallowfullscreen allowfullscreen&gt;&lt;\\/iframe&gt;<\\/p>\\r\\n<p>&lt;p&gt;&lt;a href=\\"https:\\/\\/vimeo.com\\/190834494\\"&gt;Rocky Re-dub&lt;\\/a&gt; from &lt;a href=\\"https:\\/\\/vimeo.com\\/user33363255\\"&gt;DragonMurphy Art (David Murphy)&lt;\\/a&gt; on &lt;a href=\\"https:\\/\\/vimeo.com\\"&gt;Vimeo&lt;\\/a&gt;.&lt;\\/p&gt;<\\/p>","fulltext":"","state":2,"catid":"2","created":"2016-12-14 03:44:17","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:44:17","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(9, 4, 1, '', '2016-12-14 03:45:36', 500, 1827, '12da41a8e250182d4d2ff3812fe43855850d796f', '{"id":4,"asset_id":"61","title":"Re-Dub","alias":"re-dub-2","introtext":"<p>Rocky Re-Dub<\\/p>\\r\\n<p><img src=\\"images\\/maxresdefault.jpg\\" alt=\\"\\" \\/><\\/p>\\r\\n<p>\\u00a0<\\/p>\\r\\n<p>https:\\/\\/vimeo.com\\/190834494<\\/p>\\r\\n<p>\\u00a0<\\/p>","fulltext":"","state":2,"catid":"2","created":"2016-12-14 03:44:17","created_by":"500","created_by_alias":"","modified":"2016-12-14 03:45:36","modified_by":"500","checked_out":"500","checked_out_time":"2016-12-14 03:44:17","publish_up":"","publish_down":"","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_update_sites`
--

CREATE TABLE IF NOT EXISTS `f3pkm_update_sites` (
...
--
-- Dumping data for table `f3pkm_update_sites`
--

INSERT INTO `f3pkm_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1481687656, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1481687656, ''),
...
--
-- Table structure for table `f3pkm_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `f3pkm_update_sites_extensions` (
...
--
-- Dumping data for table `f3pkm_update_sites_extensions`
--

INSERT INTO `f3pkm_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `f3pkm_updates`
--

CREATE TABLE IF NOT EXISTS `f3pkm_updates` (
...
--
-- Dumping data for table `f3pkm_updates`
--

INSERT INTO `f3pkm_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.6.5', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_user_keys`
--

CREATE TABLE IF NOT EXISTS `f3pkm_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `f3pkm_user_notes`
--

CREATE TABLE IF NOT EXISTS `f3pkm_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `f3pkm_user_profiles`
--

CREATE TABLE IF NOT EXISTS `f3pkm_user_profiles` (
...
--
-- Table structure for table `f3pkm_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `f3pkm_user_usergroup_map` (
...
--
-- Dumping data for table `f3pkm_user_usergroup_map`
--

INSERT INTO `f3pkm_user_usergroup_map` (`user_id`, `group_id`) VALUES
(500, 8);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_usergroups`
--

CREATE TABLE IF NOT EXISTS `f3pkm_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `f3pkm_usergroups`
--

INSERT INTO `f3pkm_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `f3pkm_users`
--

CREATE TABLE IF NOT EXISTS `f3pkm_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `f3pkm_users`
--

INSERT INTO `f3pkm_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(500, 'Super User', 'David', 'dragonmurphy101@gmail.com', '$2y$10$RgU46horz.e1OgsKG3s7iOce2Q7HJZyhyGTL9g7TWIXGg4L.XfLTO', 0, 1, '2016-12-13 17:53:18', '2016-12-14 03:19:50', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `f3pkm_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `f3pkm_utf8_conversion`
--

INSERT INTO `f3pkm_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `f3pkm_viewlevels`
--

CREATE TABLE IF NOT EXISTS `f3pkm_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `f3pkm_viewlevels`
--

INSERT INTO `f3pkm_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
